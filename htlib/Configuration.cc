...
// Gary
// http://stackoverflow.com/questions/6811273/getting-fatal-error-when-including-stdlib
#include <cstdlib>
...
char *Configuration::Find(char *name)
{
    ...
    {
#ifdef DEBUG
        std::cerr << "Could not find configuration option " << name << "\n";
#endif
        return 0;
    }
}
...
{
    // Gary
    // http://forums.whirlpool.net.au/archive/610191
